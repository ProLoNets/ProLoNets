...
class ReplayBufferSingleAgent(object):
    ...
    def trim(self, amount):
        self.states_list = self.states_list[-amount:]
        self.action_probs_list = self.action_probs_list[-amount:]
        self.value_list = self.value_list[-amount:]
        self.hidden_state_list = self.hidden_state_list[-amount:]
        self.rewards_list = self.rewards_list[-amount:]
        self.step = min(self.step, amount)
        self.deeper_value_list = self.deeper_value_list[-amount:]
        self.deeper_action_list = self.deeper_action_list[-amount:]
        self.action_taken_list = self.action_taken_list[-amount:]
        self.advantage_list = self.advantage_list[-amount:]
        self.deeper_advantage_list = self.deeper_advantage_list[-amount:]
        self.full_probs_list = self.full_probs_list[-amount:]
        self.deeper_full_probs_list = self.deeper_full_probs_list[-amount:]
        self.step = amount
    ...
    def sample(self):
        ...
        # del self.states_list[t]
        # del self.hidden_state_list[t]
        # del self.action_probs_list[t]
        # del self.value_list[t]
        # del self.rewards_list[t]
        # del self.deeper_action_list[t]
        # del self.deeper_value_list[t]
        # del self.action_taken_list[t]
        # del self.advantage_list[t]
        # del self.deeper_advantage_list[t]
        # del self.full_probs_list[t]
        # del self.deeper_full_probs_list[t]
        return sample_back
